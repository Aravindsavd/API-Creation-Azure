...
$backendpoolname = "beap-$region-$environment-pgn-$clientname-api"
$listnername = "lst-$region-$environment-pgn-$clientname-api"
$backendsettingsname = "htst-$region-$environment-pgn-$clientname-api"
$healthprobename = "prb-$region-$environment-pgn-$clientname-api"
$rulename = "fwr-$region-$environment-pgn-$clientname-api"
$applicationgatewayname = "agw-$region-prd-pgn"
...
$sslCert = Get-AzApplicationGatewaySslCertificate -ApplicationGateway $appgateway -Name "wildcard.paragon-apteancloud.com"
...
$RecordSet = New-AzDnsRecordSet -Name $dnsrecordname -RecordType CNAME -ResourceGroupName "rg-westuk-prd-pgn"  -TTL 3600 -ZoneName "paragon.apteancloud.com" -DnsRecords $Records
...
Write-Host "Create a SD Ticket for Cloudflare A Record"
Write-Host "Client URL will be https://$dnsrecordname.paragon.apteancloud.com"
